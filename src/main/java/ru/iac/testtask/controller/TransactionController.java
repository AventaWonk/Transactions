...
public class TransactionController {
    ...
    public String index(@RequestParam(required=false, name="limit", defaultValue = "10") int limit,
        ...
        int totalPages = PaginationUtil.calculatePageCount(transactionCount, limit);
    ...
    public String indexGroup(@RequestParam String group,
        ...
        int totalPages = PaginationUtil.calculatePageCount(transactionGroupAmountDto.getTotalOperations(), limit);

        model.addAttribute("transactionGroups", transactionGroupAmountDto.getOperations());
        model.addAttribute("grouped", group);
        model.addAttribute("totalPages", totalPages);
        model.addAttribute("currentPage", 1);
    ...
    public String getByPage(@PathVariable int page,
        ...
        int transactionCount = this.transactionService.getTransactionCount();
        int totalPages = PaginationUtil.calculatePageCount(transactionCount, limit);
        List<Transaction> transactionList = this.transactionService.getAllTransactions((page - 1) * limit, limit, orderUtil);
    ...
    public String getByPageAndGroup(@PathVariable int page,
        ...
        OrderByStatementUtil orderUtil = new OrderByStatementUtil(Transaction.getSortableColumns(), sort, order);
        AmountDto<TransactionGroupDto> transactionGroupAmountDto = this.transactionService.
                getTransactionGroupsByColumn(group, (page - 1) * limit, limit, orderUtil);
        int totalPages = PaginationUtil.calculatePageCount(transactionGroupAmountDto.getTotalOperations(), limit);
