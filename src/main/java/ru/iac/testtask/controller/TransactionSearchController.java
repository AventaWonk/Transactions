...
public class TransactionSearchController {
    ...
    public String search(@RequestParam(required=false, name="product", defaultValue = "-1") int productId,
                         @RequestParam(required=false, name="start") @DateTimeFormat(pattern = "dd/MM/yyyy HH:mm") Date start,
                         @RequestParam(required=false, name="end") @DateTimeFormat(pattern = "dd/MM/yyyy HH:mm") Date end,
    ...
    public String searchByProduct(@RequestParam("product") int productId,
                         ...
                         @RequestParam(required=false, name="sort", defaultValue = "default") String sort,
                         @RequestParam(required=false, name="order", defaultValue = "default") String order,
                         Model model) {
        ...
        int totalPages = PaginationUtil.calculatePageCount(transactionAmountDto.getTotalOperations(), limit);
    ...
    public String searchByProduct(@PathVariable int page,
        ...
        OrderByStatementUtil orderUtil = new OrderByStatementUtil(Transaction.getSortableColumns(), sort, order);
        AmountDto<Transaction> transactionAmountDto = this.transactionService.
                getTotalAmountByProductId(productId, (page - 1) * limit, limit, orderUtil);
        int totalPages = PaginationUtil.calculatePageCount(transactionAmountDto.getTotalOperations(), limit);
    ...
    public String searchByPeriod(@PathVariable int page,
        ...
        OrderByStatementUtil orderUtil = new OrderByStatementUtil(Transaction.getSortableColumns(), sort, order);
        AmountDto<Transaction> transactionAmountDto = this.transactionService
                .getTotalAmountByPeriod(start, end, (page - 1) * limit, limit, orderUtil);
        int totalPages = PaginationUtil.calculatePageCount(transactionAmountDto.getTotalOperations(), limit);
    ...
    public String searchByProductAndPeriod(@PathVariable int page,
        ...
        OrderByStatementUtil orderUtil = new OrderByStatementUtil(Transaction.getSortableColumns(), sort, order);
        AmountDto<Transaction> transactionAmountDto = this.transactionService
                .getTotalAmountByProductIdAndPeriod(productId, start, end, (page - 1) * limit, limit, orderUtil);
        int totalPages = PaginationUtil.calculatePageCount(transactionAmountDto.getTotalOperations(), limit);
